...
import time
import logging
from core.config import config_dict, summary_dict, update_config, update_summary, load_summary, init_config
...
class Role:
    ...
    def start(self):
        ...
        create_dir_if_does_not_exist(output_env_dir_path)
