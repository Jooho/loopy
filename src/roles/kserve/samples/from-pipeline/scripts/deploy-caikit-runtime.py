...
def deploy_runtime(protocol, endpoint, token, namespace="pipeline-test"):
    ...
    container_port = [{"containerPort": 8080, "protocol": "TCP"}]
    if protocol == "grpc":
        container_port = [
                ...
                },
                {
                    ...
                    "env": [
                        ...
                        },
                        {
                            ...
                            "value": "true" if enable_grpc else "false",
                        },
                        {
                            "name": "RUNTIME_HTTP_ENABLED",
                            "value": "true" if enable_http else "false",
                        },
                    ],
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--token", type=str, help="OpenShift Endpoint API access token."
    )
    parser.add_argument(
        "-n", "--namespace", type=str, default="", help="OpenShift namespace."
    )
